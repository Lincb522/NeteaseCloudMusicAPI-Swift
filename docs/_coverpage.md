...
- <i data-lucide="unlock" style="width:16px;height:16px;vertical-align:middle;stroke:#22C55E"></i> 多音源解灰 · 导入第三方 JS 音源 · 自定义地址 · 协议扩展
- <i data-lucide="book-open" style="width:16px;height:16px;vertical-align:middle;stroke:#22C55E"></i> 完整中文文档 · SwiftUI 示例应用（12 个测试模块）
